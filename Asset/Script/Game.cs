...
public class Game : MonoBehaviour
{
    ...
    void Start()
    {
        PlayerWhite = new GameObject[]
        {
         ...
         Create("white_bishop",5,0), Create("white_knight",6,0), Create("white_rook",7,0),Create("white_pawn", 0, 1),
        ...
        PlayerBlack = new GameObject[]
        {
         ...
         Create("black_bishop",5,7), Create("black_knight",6,7), Create("black_rook",7,7),Create("black_pawn",0,6),
         Create("black_pawn", 1, 6),Create("black_pawn", 2, 6),Create("black_pawn", 3, 6),Create("black_pawn", 4, 6),Create("black_pawn", 5, 6),
         Create("black_pawn", 6, 6),Create("black_pawn",7,6)
        };

        // Set all pieces position on the position boards
    ...
    public bool PositionOnBorad(int x, int y)
    {
